...
public class EC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Electronics and Communication (EC)");
    ...
    protected void onStart() {
        ...
        )
        {
            ...
            protected void populateViewHolder(PostViewHolder viewHolder, Post model, int position) {
                if(viewHolder.Type(model.getType()).equals("Department Notice") && viewHolder.Dept_Type(model.getDept_Type()).equals("Electronics and Communication (EC)")) {
