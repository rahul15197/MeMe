...
public class Important extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Important Notices");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Post,CS.PostViewHolder> FBRA = new FirebaseRecyclerAdapter<Post, CS.PostViewHolder>(
                Post.class,
                R.layout.post_design,
                CS.PostViewHolder.class,
                mDatabaseReference
        )
        {
            @Override
            protected void populateViewHolder(CS.PostViewHolder viewHolder, Post model, int position) {
                if(viewHolder.Type(model.getType()).equals("Important Notice")) {
