...
public class AE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Automobile Engineering (AE)");
    ...
    protected void onStart() {
        ...
        )
        {
            ...
            protected void populateViewHolder(PostViewHolder viewHolder, Post model, int position) {
                if(viewHolder.Type(model.getType()).equals("Department Notice") && viewHolder.Dept_Type(model.getDept_Type()).equals("Automobile Engineering (AE)")) {
