...
public class Bsc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("B.Sc.(Computer Science)");
    ...
    protected void onStart() {
        ...
        )
        {
            ...
            protected void populateViewHolder(PostViewHolder viewHolder, Post model, int position) {
                if(viewHolder.Type(model.getType()).equals("Department Notice") && viewHolder.Dept_Type(model.getDept_Type()).equals("B.Sc.(Computer Science)")) {
