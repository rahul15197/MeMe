...
public class CS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Computer Science (CS)");
    ...
    protected void onStart() {
        ...
        )
        {
            ...
            protected void populateViewHolder(PostViewHolder viewHolder, Post model, int position) {
                if(viewHolder.Type(model.getType()).equals("Department Notice") && viewHolder.Dept_Type(model.getDept_Type()).equals("Computer Science (CS)")) {
    ...
    public static class PostViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setPhotoURL(Context ctx,String PhotoURL){
            ...
            PhotoViewAttacher photoViewAttacher = new PhotoViewAttacher(post_image);
        }
